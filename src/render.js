export const renderCard = (obj, list) => {
  ...
  link.setAttribute("href", `${obj.getOnSiteUrl()}`);
  ...
  image.setAttribute("src", `${obj.getImage()}`);
  ...
  descrText.textContent = obj.getDescription();

  descr.appendChild(descrText);
  links.appendChild(github);
  links.appendChild(liveProject);
